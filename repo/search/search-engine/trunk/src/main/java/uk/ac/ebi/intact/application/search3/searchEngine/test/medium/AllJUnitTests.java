...
public class AllJUnitTests extends TestCase {
     ...
     *                                         </pre>
     *         <p/>
     *         The CreateMediumIndexTest must be called first, otherwise there is no index available
     */
    public static Test suite() {
        final TestSuite suite = new TestSuite();
//        suite.addTest(CreateMediumIndexTest.suite());
        ...
        suite.addTest(IqlSearchTest.suite());
        return suite;
    }
