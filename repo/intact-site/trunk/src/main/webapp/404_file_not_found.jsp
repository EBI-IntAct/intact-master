...
<head>
  ...
  <meta name="description" content="The IntAct database provides a freely available, open source database system and analysis tools for protein interaction data. All interactions are derived from literature curation or direct user submissions and are freely available." />
  ...
  <tbody>
    ...
    <tr>
      ...
      <!-- leftnav START -->
         ...
         <jsp:include page="404_sidebar.html" />
        ...
        <tbody>
          <tr>
            ...
            <!-- contents START -->
                   ...
                   <jsp:include page="404_content.jsp" />
