...
public class CvObject2xmlPSI2 extends AnnotatedObject2xmlPSI2 implements CvObject2xmlI {
    ...
    public Element createExperimentalRole( UserSessionDownload session, Element parent, CvObject cvObject ) {
        // checking...
        if ( session == null ) {
            throw new IllegalArgumentException( "You must give a non null UserSessionDownload." );
        }
...
//            updateCache( session, cvObject, element );
    ...
    public Element createBiologicalRole( UserSessionDownload session, Element parent, CvObject cvObject ) {
        // checking...
        if ( session == null ) {
            throw new IllegalArgumentException( "You must give a non null UserSessionDownload." );
        }
